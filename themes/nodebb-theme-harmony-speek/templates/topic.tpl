		...
		<div class="topic-space-actions d-flex justify-content-between align-items-center" style="gap: 10px;">
			<div class="topic-badges d-flex align-items-center" style="gap: 8px;">
				...
				<span class="speek-topic-badge speek-topic-badge--outline">
					...
					<span
						class="speek-topic-badge__text"
						component="topic/post-count"
						data-total-posts="{postcount}"
			...
			<div class="topic-actions d-flex align-items-center" style="gap: 16px;">
				<div class="btn-group bottom-sheet" component="thread/sort">
					<button type="button" class="speek-btn speek-btn--ghost speek-btn--lg d-flex align-items-center gap-2 dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" aria-label="[[aria:post-sort-option, {sortOptionLabel}]]">
